...
export const modalUndoButton = requireElement<HTMLButtonElement>("modalUndoButton");
export const modalRedoButton = requireElement<HTMLButtonElement>("modalRedoButton");
